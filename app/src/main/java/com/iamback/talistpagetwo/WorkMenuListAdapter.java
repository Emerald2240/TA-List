...
public class WorkMenuListAdapter extends ArrayAdapter<NewListItems> {
    private Context mContext;
    int mResource;
    ArrayList<NewListItems> Obj;

    public WorkMenuListAdapter(Context context, int resource, ArrayList objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        ...
        TextView itemname =  convertView.findViewById(R.id.nameTextView);
        TextView pricetextview = convertView.findViewById(R.id.priceTextView);
        TextView quantTExtView = convertView.findViewById(R.id.quantityTextView);
